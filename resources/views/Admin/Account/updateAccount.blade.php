                        ...
                        <div class="update_infor_acc">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="description" id=""
                                    placeholder="{{ $account->description }}" value="{{ $account->description }}" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="price" id=""
                                    placeholder="{{ $account->price }}" value="{{ $account->price }}" />
                            </div>
                            <div class="form-group">
                                <label for="">AR: </label>
                                <input type="text" class="form-control" name="ar" id=""
                                    placeholder="{{ $account->ar }}" value="{{ $account->ar }}" />
                            </div>
                            <div class="form-group">
                                <label for="server">Server: </label>
                                <select name="server"class="form-control" id="">
                                    <option {{ $account->server == 'Asian' ? 'selected' : '' }} value="Asian">Châu Á
                                    </option>
                                    <option {{ $account->server == 'Eu' ? 'selected' : '' }} value="Eu">Châu Âu
                                    </option>
                                    <option {{ $account->server == 'Us' ? 'selected' : '' }} value="Us">Châu Mỹ
                                    </option>
                                    <option {{ $account->server == 'HongKong' ? 'selected' : '' }} value="HongKong">
                                        Hồng kông</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control">
                                    <option {{ $account->status == '1' ? 'selected' : '' }} value="1">Chưa bán
                                    </option>
                                    <option {{ $account->status == '2' ? 'selected' : '' }} value="2">Đã bán
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="btn_update_cate">
                                    <label id="btn_change_avatar" class="btn btn-outline-info" for="avatar">Hình tài
                                        khoản</label>
                                    <input name="images[]" multiple type="file" id="avatar" accept="image/*"
                                        multiple>
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    @if (isset($categories) && is_object($categories))
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                {{ $category->id == $account->account_type_id ? 'selected' : '' }}>
                                                {{ $category->game_type }}</option>
                                        @endforeach
                                    @endif
                                </select>
