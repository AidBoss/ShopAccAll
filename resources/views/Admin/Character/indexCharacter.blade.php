            ...
            <div class="manager_char">
                <div class="manager_char_left">
                    <form action="" method="get" id="filterForm">
                        <a class="btn btn-outline-info" data-category="Genshin Impact">Bảng char genshin</a>
                        <a class="btn btn-outline-info" href="#" data-category="Honkai Star Rail">Bảng char
                            honkai</a>
                        <a class="btn btn-outline-info" href="#" data-category="TFT">Bảng char tft</a>
                        <a class="btn btn-outline-info" href="#" data-category="Liên Quân Mobile">Bảng char liên
                            quân</a>
                        <a class="btn btn-outline-info" href="#" data-category="Wuthering Waves">Bảng char
                            Wuthering</a>
                    ...
                    <table class="table ListUserAccount">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th colspan="2">
                                    <a class="btn btn-success" href="{{ route('addChar.index') }}">Thêm mới nhân vật</a>
                                </th>
                            </tr>
                            <tr>
                                <th>Id:</th>
                                <th>Avarta:</th>
                                <th class="HTextTooLong">Tên nhân vật:</th>
                                <th>Loại game:</th>
                                <th>Sửa:</th>
                                <th>Xóa:</th>
                            </tr>
                        ...
                        <tbody>
                            @if (isset($characters) && is_object($characters))
                                @foreach ($characters as $char)
                                    <tr id="chinh_sua">
                                        <td scope="row">#{{ $char->id }}</td>
                                        <td>
                                            <div class="avarta_list_acc">
                                                <img src="{{ asset($char->image) }}" alt="">
                                            </div>
                                        </td>
                                        <td class="HTextTooLong">
                                            {{ $char->name }}
                                        </td>
                                        <td class="HTextTooLong">{{ $char->category->game_type }}</td>
                                        <td>
                                            <a href="{{ route('charUpdate.index', $char->id) }}" id="edit_infor_users"
                                                type="button">Sửa</a>
                                        </td>
                                        <td>
                                            <a class="btn_delete_category" href="{{ route('char.delete', $char->id) }}"
